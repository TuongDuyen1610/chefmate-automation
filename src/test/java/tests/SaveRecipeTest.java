...
//
//        searchFlow.searchByTag("Thịt Bò");
//
//        int target = 8;// 4
//        int saved = 0;
//
...
//                after,
//                before + saved,
//                "❌ Số lượng công thức lưu không đúng"
//        );
//    }
//    // =========================
...
//        login();
//
//        searchFlow.searchByTag("Xúc xích");
//
//        int target = 4;
//        int savedCount = 0;
//
...
//
//    // =========================
//    // TC_06 - SAVE BEFORE NOT LOGIN (FIX LẠI)
//    // =========================
//    @Test(priority = 6)
...
//////        openRecipeDetail();
////        searchFlow.searchByTag2("cà phê"); // hoặc data chị muốn test
////        search.clickResultAt(0);
////
////        detail.waitForLoaded();
////
...
////        );
////        //Gmail
////        boolean result3 = shareFlow.shareViaGmail();
////        Assert.assertTrue(result3, "❌ Share Gmail thất bại");
////
////        // Messenger
////        boolean result2 = shareFlow.shareViaMessenger();
////        Assert.assertTrue(result2, "❌ Share Messenger thất bại");
////
////        saved.clickBack2();
////
////        // Zalo
...
////        boolean result = shareFlow.shareViaMessenger();
////
////        Assert.assertTrue(result, "❌ Share Messenger thất bại. ❌ Không hiển thị share hoặc yêu cầu login");
////
////
////    }
//    ////    =========================
//    ////     RECIPE DELETE TEST CASES
//    ////    =========================
//    @Test(priority = 19,
...
//        Assert.assertTrue(
//                saved.isRecipeDisplayed(title),
//                "❌ Recipe vẫn còn tồn tại sau khi hủy xóa"
//        );
//    }
//
//     // ======  RecipeDelete_TC_03  =======
//    @Test(priority = 21)
//    public void RecipeDelete_TC_03() {
//        searchFlow.searchByTag("cà phê"); // hoặc data chị muốn test
//        search.clickResultAt(0);
//
//        detail.waitForLoaded();
...
////     TC_05 - MULTI SHARE Messenger + Zalo + Gmail
    @Test(priority = 17,
            description = "RecipeShare_TC_05 - Share nhiều lần qua Zalo, Messenger, Gmail")
    public void RecipeShare_TC_05() {
