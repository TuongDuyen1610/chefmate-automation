...
//        registrationCounter++;
//
//        String fullName = "Test " + registrationCounter;
//        String phone = "12345" + (1000000 + registrationCounter);
//        String email = "12345" + registrationCounter + "@gmail.com";
...
//        Assert.assertTrue(authFlow.isErrorMessageDisplayedOnRegistration(),
//                "❌ Lỗi: Phải hiển thị thông báo lỗi!");
...
//        Assert.assertTrue(authFlow.isErrorMessageDisplayedOnRegistration(),
//                "❌ Lỗi: Phải hiển thị thông báo lỗi 'Mật khẩu không trùng khớp'!");
//        System.out.println("✅ DangKy_TC_08 PASS");
//    }

    @Test(priority = 1, description = "DangKy_TC_09 - Không tick Điều khoản")
    public void DangKy_TC_09_RegistrationNoTermsAgreement() {
        ...
        authFlow.registerWithoutTermsAgreement(fullName, phone, email, password);

        // Verify 1: Hiển thị error message
        Assert.assertTrue(authFlow.isErrorMessageDisplayedOnRegistration(),
                "❌ Lỗi: Phải hiển thị thông báo lỗi 'Vui lòng đồng ý với điều khoản dịch vụ'!");

        // Verify 2: Vẫn ở màn Đăng ký
        Assert.assertTrue(registration.isRegistrationScreenDisplayed(),
                "❌ Lỗi: Phải vẫn ở màn Đăng ký!");
