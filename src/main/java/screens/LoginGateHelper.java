...
public class LoginGateHelper extends BaseScreen {
    ...
    // XPath rút gọn dựa trên cấu trúc chị gửi: //.../android.view.View[2]/android.view.View/android.widget.Button
    private final By btnOpenLoginForm = By.xpath("//android.view.View[2]/android.view.View/android.widget.Button");
