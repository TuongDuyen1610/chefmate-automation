...
/**
 * AllureHelper.java
 * ✅ Cung cấp utility methods cho Allure Report / AllureHelper đang thực hiện đúng vai trò chụp snapshot thủ công trong step-by-step.
 mvn clean test -DsuiteXmlFile=suites/testng-e2e-integration.xml
 1. Biên dịch báo cáo tĩnh (Đưa dữ liệu vào folder cố định):
 allure generate target/allure-results --clean -o target/allure-report
 (Lệnh này đọc dữ liệu đã gom lịch sử từ allure-results,
 sau đó xây dựng trang báo cáo chính thức hoàn chỉnh nằm tại target/allure-report).
 2. Khởi chạy máy chủ nội bộ mở Website:
